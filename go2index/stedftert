...
<head>
  ...
  <style>
    @import url(https://cdn.jsdelivr.net/gh/Kaanibaru/goindex-theme-acrou@master/dist/style.min.css);
  </style>
  <script>
...
<body>
    <div id="app"></div>
    <script src="https://cdn.jsdelivr.net/gh/Kaanibaru/goindex-theme-acrou@master/dist/app.min.js"></script>
</body>
</html>
`;
}
